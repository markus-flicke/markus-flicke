...
## 🛠️ More Public Projects

- [Travelling-Salesman-solved-by-EA](https://github.com/markus-flicke/Travelling-Salesman-solved-by-EA) — Solving the travelling salesman problem with a genetic algorithm.
- [Kmeans](https://github.com/markus-flicke/Kmeans) — My own Python implementation of K-means clustering.
- [Corona](https://github.com/markus-flicke/Corona) — Dynamic graph visualisation of 2020 Wikipedia data on the Corona virus outbreak.
- [cosine-similarity-bert](https://github.com/markus-flicke/cosine-similarity-bert) — Computing semantic similarity with BERT embeddings.
- [face_recognition](https://github.com/markus-flicke/face_recognition) — Face recognition experiments.
- [ImitationLearning](https://github.com/markus-flicke/ImitationLearning) — Experiments in imitation learning.
- [VideoPathFromPDF](https://github.com/markus-flicke/VideoPathFromPDF) — Extracting video paths/links from PDF documents.
